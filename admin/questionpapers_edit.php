...
$sql = "UPDATE texamenes SET " .
	"fecha='" . $_REQUEST['fecha'] . "', idusuario=" . $_SESSION['idusuario'] . ", claveexamen='" . $_REQUEST['claveexamen'] . "'," .
...
if (mysqli_query($base_selection, $sql)) {
	echo "El examen se actualiz� correctamente <br> ";
